...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden vignette film-grain">
      ...
      {/* Subtle crimson to purple accent glow */}
      <div
        className="absolute inset-0 opacity-30"
        style={{
          background: "radial-gradient(ellipse at 50% 20%, rgba(212, 18, 18, 0.4) 0%, rgba(74, 0, 51, 0.2) 40%, transparent 70%)",
        }}
      />
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 text-center">
        <div className="animate-fade-in">
          ...
          <h1 className="text-[8rem] sm:text-[10rem] md:text-[14rem] lg:text-[18rem] xl:text-[22rem] font-black leading-none mb-8 gradient-text title-dramatic tracking-widest">
            {t("title")}
          </h1>
